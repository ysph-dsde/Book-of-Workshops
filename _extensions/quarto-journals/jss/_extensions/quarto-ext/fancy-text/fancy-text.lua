...
function latex()
  ...
  elseif quarto.doc.is_format("bookup-html") then
...
function bibtex()
  ...
  elseif quarto.doc.is_format("bookup-html") then
    return pandoc.RawBlock('bookup-html', '<span style="font-variant: small-caps;">Bib</span><span style="letter-spacing:-2px;">T</span><sub style="font-size: inherit; letter-spacing:-1px;">E</sub>X')
  else
