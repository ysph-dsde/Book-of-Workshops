...
5. Confirm that Git has been initialized by checking the project status. If the project is initialized, you should see that Git is present and tracking files.
    ...
    If instead, you see the following message, you will need to initialize Git as shown above in the section [Initializing the Environment](#initializing-the-environment).
