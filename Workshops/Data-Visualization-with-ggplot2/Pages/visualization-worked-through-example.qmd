...
# `ggplot2` Worked-Through Example {.unnumbered}
...
::: img-float
![Figure from "ggplot2 workshop part 1" by Thomas Lin<br>Pedersen. Accessed from YouTube March 15th, 2025.](../Images/All Layers.png){style="float: left; position: relative; top: 0px; padding-right: 30px; margin: -1em auto -1.5em auto;" width="350"}
:::
...
<div class="callout-discussion">
    ...
    <p>Can you think of reasons why you would choose one over the other?</p>
</div> 
```
...
<div class="callout-discussion">
    ...
    <p>We see that associating a variable with an <code>aes(color)</code> will also group by that same variable.</p>
    <ul>
...
[![Figure 5.5 from "Data Visualization: From Theory to Practice" by James Baglin. Accessed March 22nd, 2025.](../Images/Coordinates Diagram.png){width="750" height="188"}](https://dark-star-161610.appspot.com/secured/_book/grammar-and-vocabulary.html#coord)
...
<div class="callout-discussion">
    ...
    <p>If we apply each option individually, do they all plot the same way? If not, what do you think is happening and how would you fix the code?</p>
</div> 
```
