...
tool to be executed in environments like Mac's Terminal. Using the Git CLI allows users to directly execute Git operations, offering fine-grained control that is often not possible with third-party GUIs or IDEs. Consequently, relying solely on GUIs or IDEs can limit a learner's growth and understanding of the full capabilities of Git and its interaction with GitHub.
...
-   [Git and GitHub Tutorial](https://www.w3schools.com/git/default.asp?remote=github) by W3Schools\ [@w3schools]
-   [*"Introduction to GitHub"*](https://github.com/skills/introduction-to-github) by GitHub\ [@github_intro_course]
-   [*"Happy Git and GitHub for user"*](https://happygitwithr.com/) by [Professor Jenny Bryan](https://jennybryan.org/) (and Yale alumn!) and [Jim Hester](https://www.jimhester.com/)
\ [@happy_git_github]
