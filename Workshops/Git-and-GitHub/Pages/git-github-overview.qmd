...
<figure style="float: right; position: relative; margin-left: 1em; margin-top: 0em; margin-bottom: 0em;">
  ...
  <img src="../Images/XKCD_Painbow_downloaded 04.22.2025.png" alt="xkcd Painbow comic" style="margin-bottom: 1em;" width="350">
  </a>
...
<figure style="float: right; position: relative; margin-top: 0.5em; margin-bottom: 0.5em;">
  <img src="../Images/Example Workflow.png" alt="Summary workflow" style="margin-bottom: 1em;" width="100%">
...
<figure style="float: left; position: relative; margin-right: 0em; margin-top: 0em; margin-bottom: 0em;">
  ...
  <img src="../Images/Atlassian git Tutorials_git pull context_downloaded 04.24.2025.png" alt="Atlassian's Branches" style="margin-bottom: 1em;" width="450">
  </a>
...
<figure style="float: left; position: relative; margin-top: 0em; margin-bottom: 0em;">
  ...
  <img src="../Images/Atlassian git Tutorials_git merge_downloaded 04.24.2025.png" alt="Atlassian's Merge" style="margin-bottom: 1em;" width="350">
  </a>
</figure>
```
...
<figure style="float: left; position: relative; margin-top: 0em; margin-bottom: 0em;">
  ...
  <img src="../Images/Atlassian git Tutorials_git rebase context_downloaded 04.24.2025.png" alt="Atlassian's Rebase" style="margin-bottom: 1em;" width="400">
  </a>
</figure>
```
:::
...
# Inspect changes.
git branch -a    # Lists all local branches, including remote copies
git status       # Summary of status differences between the two versions
git diff main    # Summary of code differences between the two versions
