...
In this workshop, you'll access R code for challenge questions. If you haven't already, please download the latest version of [R](https://cran.r-project.org/) to your device. We also recommend using the latest version of [RStudio](https://posit.co/download/rstudio-desktop/) as your Integrated Development Environment (IDE).
...
1. Download the prepared codebase, which is configured as an RStudio project and includes code for in-class challenge questions with solutions.
...
4.  Open `Challenge Questions.R`. To ensure this script opens in the correct project RStudio window, you can use the "Files" pane inside RStudio to launch the scripts.
