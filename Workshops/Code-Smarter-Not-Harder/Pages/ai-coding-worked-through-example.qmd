...
- Solve the same problem using [Yale's AI Clarity](https://ai.yale.edu/yales-ai-tools-and-resources/clarity-platform) chatbot and GitHub Copilot in Positron, then compare the results
