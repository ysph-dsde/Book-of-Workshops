...
{{< downloadthis "Data-Visualization-with-ggplot2/Materials/Discussion and Challenge Questions Download_03.26.2025.zip" label="Codespace for Discussion and Challenge Questions" id=download_btn >}}
...
{{< downloadthis "Data-Visualization-with-ggplot2/Materials/Workshop Slide Deck with Comments.pdf" label="Complete Slide Deck" id=download_btn >}}

{{< downloadthis "Data-Visualization-with-ggplot2/Materials/Handout.pdf" label="Handout" id=download_btn >}}
